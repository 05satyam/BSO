...
class Particle:
    def __init__(self,x0):
        ...
        for i in range(0,num_dimensions):
            self.velocity_i.append(random.uniform(low,up))
    ...
    # update:wnew particle velocity
    def update_velocity(self,pos_best_g):
        w = .9  # constant inertia weight (how much to weigh the previous velocity)
...
# low=0  #langermann
# up=10
low = -1 #non continuous rastrigin
up =1
num_of_iter=100
dimensions=2
fitness = NonContinuousFunctions.quadric
...
while exp<num_of_iter:
    ...
    PSO(fitness,initial,bounds,num_particles= 100,maxiter= 3000)

    print(exp+1, " - ", "  count: ",count)
...
wb.save('Server-Results/PSO_5_'+str(fitness.__name__)+'_'+str(dimensions+1)+'.xls')
