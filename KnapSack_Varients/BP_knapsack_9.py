...
START_RESULTANT = 6  # start step size
...
file_name='BP_knapsack_16nov-90-100_' + str(fitness.__name__) + '_' + str(DIMENSIONS + 1) + '.xls'
...
while exp < NUM_OF_ITERATIONS:  # number of experiments or number of trials
    ...
    ITEMS = KnapSack.item_list_10[exp]
    RANGES = KnapSack.range_list_10[exp]
