...
=======
ROUNDS = 19000000
>>>>>>> 590d8afba91e43418030ecbe1b5bde4ef43bfff1

>>>>>>> afb8847c1c294fe073eb801b266978c5cb5bd956

T = np.linspace(INTIAL_TEMP, 0, ROUNDS)
times = []
results = []
...
MAX_TRIALS=30
<<<<<<< HEAD
file_name='TA_knapsack_17nov_20-30_10min_'+ str(fitness.__name__) + '_' + str(dimensions + 1) + '.xls'
=======
file_name='TA_knapsack_16nov_'+str(e) + '_'+ str(fitness.__name__) + '_' + str(dimensions + 1) + '.xls'
>>>>>>> afb8847c1c294fe073eb801b266978c5cb5bd956
...
def accept_neighbor(current_value, neighbor_value, temperature):
    DE = current_value - neighbor_value
    if DE <= temperature:
        return True

#creating new neighbours
...
# Define the threshold accepting algorithm
def threshold_accepting(CAPACITY, RANGES):
...
while e < MAX_TRIALS:
    ...
    best_solution, best_value = threshold_accepting(CAPACITY, RANGES)
