...
n_whales = 250  #Number of whales
dimensions = 19  # Dimensionality of the search space
...
while e < MAX_TRIALS:
    ...
    print("e - ",e, "  fitness val-  ", best_fitness_val, " best_solution ", best_solution)
...
if (generateTrailsCSV):
    ...
    wb.save('WO_knapsack_17nov_'+str(e) + '-'+str(MAX_TRIALS)+'_'+ str(fitness.__name__) + '_' + str(dimensions + 1) + '.xls')
