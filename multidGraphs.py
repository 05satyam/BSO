...
excel_path = "Server-Results/Convergence_Results/functions/New_Time/"+funcs[0]\
         +"NonContinuous_Convergence_MAE.xls"
...
for f in funcs:
    ...
    plt.savefig('plotting_img/res_graphs/'+ funcs[0]+'_MAE_NonContinuous_New_Time_10sept.png', dpi=300)
    plt.show()
